<html>
	<head><title>Search Accessories</title></head>
...
?>
    ...
    <div class="sidenav">
     ...
     <div class="main">
    <center><br></br><form action="../view/searchAcc.php" method="POST">
    ...
    <?php
        if(isset($_POST['search_submit'])) 
        {
            ...
            $sql = "SELECT * FROM acc_product WHERE accName LIKE'%$search%' OR accBrands LIKE'%$search%' OR accGender LIKE'%$search%' OR accPrice LIKE'%$search%'";
            ...
            if($queryresult >0) 
            {
                ...
                while($row = mysqli_fetch_assoc($result)) 
                {
                    ...
                    <tr>	
                        ...
                        <td><?php echo $row['accPrice'] ?></td>
                        <td><?php echo $row['accSize'] ?></td>
                        <td><?php echo $row['accQty'] ?></td>
    
                        <td>
                            <a style="align:center"href="../view/editAttAdmin.php?id=<?php echo $row['accId']; ?>"><img src="images/edit.png"  style="width:35px;height:35px"></a>
                            <a style="align:center"href="../view/deleteAtt.php?id=<?php echo $row['accId']; ?>"><img src="images/delete.png"  style="width:30px;height:30px"></a>
                        </td>
                    </tr>
