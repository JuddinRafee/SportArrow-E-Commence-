<html>
	<head><title>Search Attires</title></head>
...
?>
     ...
     <div class="main">
    <center><br></br><form action="../view/searchAtt.php" method="POST">
    ...
    <?php
        if(isset($_POST['search_submit'])) 
        {
            ...
            $sql = "SELECT * FROM attire_product WHERE attName LIKE'%$search%' OR attBrands LIKE'%$search%' OR attGender LIKE'%$search%' OR attPrice LIKE'%$search%'";
