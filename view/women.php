...
$productAttireM = $Product->getAttireList('F');
$productShoesM = $Product->getShoesList('F');
$productAcceM = $Product->getAcceList('F');
?>
...
<body>
    ...
    <img src="images/headerW.png"style="width:50%;height:500px;" ><img src="images/headerW3.png"style="width:50%;height:500px;" >
    <div class="row">
  		<div class="columnL" style="background-color:white ;">
    		<div class = "link" >
            <h5 style ="color : black; font-family:calibri;text-decoration:none;padding-left:8em; font-size:15px">Women's</h5>
        ...
        <br><br>
        <!--<h5 style ="color : black; font-family:calibri;text-decoration:none;padding-left:8em; font-size:15px">Search : </h5>
        <form class="search" action="../view/women.php" style="margin:auto;max-width:300px;		padding-left:6em;">
